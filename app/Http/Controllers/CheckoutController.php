...
class CheckoutController extends Controller
{
    ...
    {
        $this->middleware('check.sessions')->except(['index', 'one-touch-plans']);
    ...
    public function oneTouchIndex(Request $request)
    {
        $this->processCoupons();
        $response = $this->getCartOrder($request);
        $states = StatesProvider::data();
...
//        return view(
//            'checkout.one-touch-index',
//            compact('subtotalPrice', 'activeGroupId', 'states', 'customerCards')
//        );
    }
