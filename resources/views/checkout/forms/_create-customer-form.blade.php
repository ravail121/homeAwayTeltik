{!! Form::open(['route' => 'create.customer', 'class' => 'create-customer-form', 'id' => 'create-customer-form-with-id']) !!}
		...
		<div class="panel panel-default">
			<div class="panel-heading" role="tab" id="headingOne">
				<h4 class="panel-title" id='panel-tile-1'>
					<a role="button" class="collapse-trigger" id='trigger-1' data-toggle="collapse" href="#coll"
                       aria-expanded="true" aria-controls="collapseOne">
						<span class="checkout-label">1.</span>
                        {{ session('id') ? 'Shipping Info': ' Customer Info' }}
					</a>
					<ul class="pull-right d-flex vertical-align flex-content-center">
                        @if (!session('id'))
{{--                            <li>--}}
{{--                                <a href="#" class="f16 system-text"><i class="fa fa-pencil-alt customer-info-edit"></i></a>--}}
{{--                            </li>--}}
                        @endif
                        @if (session('id') && session('new_customer'))
                            <li>
                                <i class="fa fa-check f16 system-text"></i>
                            </li>
                        @endif
                        {{-- @if (session('id'))
                            <li>
            ...
            @endif
				<div class="panel-body">
                    ...
                    {!! Form::button(
    session('id') ? 'Update' : 'Save & Login',
     ['class' => session('id') ? 'add-top-2 btn style2 add-bottom-2 update-customer system-background'
     : 'add-top-2 btn style2 add-bottom-2 create-customer system-background',
      'type' => 'submit', 'id' => 'create-customer-button']
      ) !!}
				</div>
			</div>
		</div>
