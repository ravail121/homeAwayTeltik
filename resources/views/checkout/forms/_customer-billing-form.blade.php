{!! Form::open(['route' => 'checkout.store', 'class' => 'customer-billing-form']) !!}
   ...
   {{-- @endif --}}
        <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingTwo">
                <h4 class="panel-title" id='panel-tile-2'>
                    <a class="collapse-trigger" role="button" id='trigger-2' data-toggle="collapse"  href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" id='collapse-2-trigger'>
                        <span class="checkout-label">2.</span> Billing Info
                    </a>
                    <ul class="pull-right d-flex vertical-align flex-content-center">
                        @if (!session('id'))
                            @if (isset(session('cart')['customer']['billing_state_id']) && session('cart')['customer']['billing_state_id'] != 'N/A')
                                <li>
                                    <i class="fa fa-check f16 system-color"></i>
                                </li>
                                <li>
                                    <a href="#" class="t-violet-2 system-color">
                                        <i id='collapse-button-2' class="fa f16 caret-btn fa-caret-right">
                                        </i>
                                    </a>
                                </li>
                            @endif
                        @else
                            @if (isset(session('cart')['business_verification']['billing_state_id']) && session('cart')['business_verification']['billing_state_id'] != 'N/A')
                                @if (session('new_customer'))
                                    <li><i class="fa fa-check f16 system-text"></i></li>
                                @endif
                                <li>
                                    <a href="#" class="t-violet-2 system-text">
                                        <i id='collapse-button-2' class="fa f16 caret-btn fa-caret-right"></i>
                                    </a>
                                </li>
                            @endif
                        @endif
                        @if (session('id') && session('new_customer') && !isset(session('cart')['business_verification']['billing_state_id']))
                            <li><a href="#" class="f16 system-text">
                                    <i class="fa fa-pencil-alt customer-info-edit"></i>
                                </a></li>
                        @endif
                    </ul>
                </h4>
            ...
            @endif
                <div class="panel-body billing-fields">
                    <div class="row">
                        <div class="col-xs-12">
                            <h6 class="text-left bold f14 t-black-1 add-bottom-3">Billing Information updated</h6>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                {!! Html::decode(Form::label('billing-fname', 'First Name updated<span class="text-danger"> *</span>')) !!}
                    ...
                    <button type='button' id='save-tax' class='add-top-2 btn style2 add-bottom-2 system-background'>
        ...
        <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingThree">
                <h4 class="panel-title" id = 'panel-tile-3'>
                    <a role="button" class="collapse-trigger" data-toggle="collapse"
                       href="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                        <span class="checkout-label">3.</span> Payment Info
                    </a>
                        ...
                        @if (!session('id'))
                            @if (session('new_customer'))
                                ...
                                @if (isset(session('cart')['customer']['billing_state_id']) && session('cart')['customer']['billing_state_id'] != 'N/A' && !session('new_customer'))
                                    <li>
                                        <a href="#" class="t-violet-2 system-text">
                                            <i id='collapse-button-3' class="fa f16 caret-btn fa-caret-right"></i>
                                        </a>
                                    </li>
                                @endif
                            @endif
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <div class="input-group add-bottom-3 mt-20">
                                        ...
                                        <span id='coupon-buttons' class="input-group-btn c-buttons">
                                            {!! Form::button(
                                            'Apply',
                                             ['class' => 'btn style1 system-color', 'id' => 'coupon-apply'
                                             ]) !!}
                                        </span>
                                    </div>
                                                    ...
                                                    <div class="coupon-code-cart">
                                                        ...
                                                        <a class="remove-coupon-button cursor-pointer"
                                                           ...
                                                           title="Remove coupon {{ $couponCode }}">
                                                            <i class="fa fa-trash remove-coupon" aria-hidden="true"
	...
	<div class="form-notif system-background">
		<div class="form-notif-wrap d-flex vertical-align flex-content-spacebetween">
			...
			<div style='color:white' class="fonts-phones">
                <strong>Total Due Today updated: </strong>
