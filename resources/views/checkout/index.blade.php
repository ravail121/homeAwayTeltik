...
@section('content')
	<!-- content -->
	<section class="choose-device-content mt-0">
		<div class="container">
...
@push('js')
    <script>
        ...
        $(function(){
            ...
            iTag  = '<i class="fa fa-check f16 system-text"></i>';
            liTag = '<li><a href="#" class="t-violet-2 system-text"><i class="fa f16 caret-btn fa-caret-right"></i></a></li>';
        ...
        {
            scrollTriggerWithPosition(target.replace('#', ''));
            // $('html, body').animate({
            //     scrollTop: $(target).position().top
            // }, 2000);
        }

        function scrollTriggerWithPosition(elementId) {
            setTimeout(() => {
