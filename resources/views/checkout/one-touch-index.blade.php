...
@section('content')
	<!-- content -->
	<section class="choose-device-content checkout-page">
		<div class="container">
{{--			@include('processes.process-steps')--}}
			<div class="row no-margin pad-top-10 text-center">
                <div class="d-flex justify-content-center">
                    <h1 class="content-title system-text">You are almost done here!</h1>
                </div>
					...
					<div class="checkout-section">
						<div class="row">
							<div class="col-md-7 col-sm-12 col-xs-12 left-con">
								@include('checkout.oneTouch.forms._create-customer-form')

								@include('checkout.oneTouch.forms._customer-billing-form')
    ...
    <script>
        ...
        $(function(){
            ...
            const
                ...
                $customerFormId         = $('#create-customer-form-with-id'),
            ...
            var billingStateId   = $('#billing-state'),
                ...
                $cvv             = $('#payment-cvc');
            // console.log('===>', $expireDateInputMask);
            ...
            $('#place-order-button').click(()=>{
                ...
                if (typeof $customerBillingForm.valid === 'function' && $customerBillingForm.valid()) {
