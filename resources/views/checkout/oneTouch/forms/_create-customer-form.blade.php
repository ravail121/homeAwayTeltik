{!! Form::open(['route' => 'create.customer', 'class' => 'create-customer-form']) !!}
	...
	<div class="panel-group section-one" id="accordionOne" role="tablist" aria-multiselectable="true">
		<div class="panel panel-default">
			<div class="panel-heading" role="tab" id="headingOne">
				<h4 class="panel-title d-flex justify-content-between" id='panel-tile-1'>
					<a role="button" class="collapse-trigger system-text" id='trigger-1' data-toggle="collapse" href="#coll"
                       aria-expanded="true" aria-controls="collapseOne" data-bs-toggle="collapse">
						<span>1.</span> {{ session('id') ? 'Shipping Info': ' Customer Info updated' }}
					</a>
            ...
            @endif
				<div class="panel-body">
					...
					<div class="row">
						@if (!session('id'))
							<h4 class="text-left bold t-black-1 pad-left-15 pad-bottom-2 system-text">Shipping Info</h4>
                        @endif
						<div class="col-sm-6 col-xs-12">
    ...
    session('id') ? 'Update' : 'Save & Login',
     [
         'class' => session('id') ? 'mt-4 add-top-2 btn style2 add-bottom-2 update-customer system-background' :
         'mt-4 add-top-2 btn style2 add-bottom-2 create-customer',
          'type' => 'submit',
