...
<div class="panel-group" id="accordionTwo" role="tablist" aria-multiselectable="true">
    ...
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingTwo">
            <h4 class="panel-title d-flex justify-content-between" id='panel-tile-2'>
                <a class="collapse-trigger system-text" role="button" id='trigger-2' data-toggle="collapse" href="#collapseTwo"
                   aria-expanded="false" aria-controls="collapseTwo" id='collapse-2-trigger' data-bs-toggle="collapse">
                ...
                <ul class="pull-right d-flex vertical-align flex-content-center">
                    @if (!session('id'))
                        @if (isset(session('cart')['customer']['billing_state_id']) && session('cart')['customer']['billing_state_id'] != 'N/A')
                            ...
                            <li>
                                <a href="#" class="t-violet-2"><i id='collapse-button-2'
                                                                  class="fa f16 caret-btn fa-caret-right"></i></a>
                            </li>
                        @endif
                    @else
            ...
            @if (session('cart')['business_verification']['billing_state_id'])
                            ...
                            @else
                                <div id="collapseTwo" class="panel-collapse collapse show" role="tabpanel"
                                    ...
                                    <div class="panel-body billing-fields">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <h6 class="text-left bold f14 t-black-1 add-bottom-3">Billing
                                                    Information</h6>
                                            ...
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    {!! Html::decode(Form::label('billing-fname', 'First Name one touch<span class="text-danger"> *</span>')) !!}
                                        ...
                                        <button type='button' id='save-tax'
                                                class='add-top-2 btn style2 add-bottom-2 checkout-button mt-4'>
                                            @if (isset(session('cart')['customer']['billing_state_id'])
                                                 && session('cart')['customer']['billing_state_id']
                                                 || isset(session('cart')['business_verification']['billing_state_id']) &&
                                                  session('cart')['business_verification']['billing_state_id'])
                                                Update
                                            @else
                                                Save & Continue
                                            @endif
                                ...
                                <div class="col-xs-12 hide-this-con">
                                    @include('checkout.cart._one-cart')
                                </div>
                ...
                <div class="panel-group" id="accordionThree" role="tablist" aria-multiselectable="true">
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingThree">
                            <h4 class="panel-title" id='panel-tile-3'>
                                <a role="button" class="collapse-trigger system-text" data-toggle="collapse" href="#collapseThree"
                                   aria-expanded="true" aria-controls="collapseThree" data-bs-toggle="collapse">
                                ...
                                <div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    @else
                                                    ...
                                                    @if (session('id'))
                                                        <div class="panel-body">
                                                            ...
                                                            @if (session('id'))
                                                                <div class="row">
                                                                    <div class="col-sm-6 col-xs-12">
                                                                        <h6 class="text-left bold f14 t-black-1 add-bottom-2">
                                                                            Apply Coupon</h6>
                                                                        <div class="input-group add-bottom-3 mt-20">
                                                                            {!! Form::text('coupon', null, ['class' => 'form-control', 'id' => 'coupon']) !!}
                                                                            <span id='coupon-buttons'
                                                                                  class="input-group-btn c-buttons">
                                            {!! Form::button('Apply', ['class' => 'btn style1', 'id' => 'coupon-apply']) !!}
                                        </span>
                                                                        </div>
                                                                        <div id='coupon-list-message'
                                                                             class="add-bottom-3 mt-20">
                                                                            @if (session('couponCodes'))
                                                                                @foreach(session('couponCodes') as $couponCode)
                                                                                    <div
                                                                                        class="coupon-code-text-wrapper text-left mb-5">
                                                                                        <div class="coupon-code-cart">
                                                                                            {{ $couponCode }}
                                                                                            <a class="remove-coupon-button cursor-pointer"
                                                                                               title="Remove coupon {{ $couponCode }}">
                                                                                                <i class="fa fa-trash remove-coupon"
                                                                                                   aria-hidden="true"
                                                                                                   data-coupon-id="{{ $couponCode }}"></i>
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                @endforeach
                                                            ...
                                                            @isset ($customerCards)
                                                                <div class="row">
                                                                    <div class="col-sm-6 col-xs-12">
                                                                        <h4 class="text-left bold f14 t-black-1 add-bottom-2">
                                                                            Select Card</h4>
                                                                ...
                                                                @endforeach
                                                                <div
                                                                    class="form-check add-bottom-3 {{ session('new_customer') || !count($customerCards) ? 'd-none' : '' }}">
                                                                    ...
                                                                    @else
                                                                        <div class='payment-fields'>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-xs-12">
                                                                                    <div class="form-group">
                                                                                        <label for="payment-card-no"
                                                                                               class="d-block">
                                                                                            Credit Card No.<span
                                                                                                class="text-danger"> *</span>
                                                                                            {{-- <span class="t-gray-2 f12 bold pull-right">Pay with Visa, Mastercard, Maestro &amp; Amex</span> --}}
                                                                                            <img
                                                                                                class="pull-right padding-b-5"
                                                                                                src="{{ asset('theme/images/visa-card-icon-10.jpg') }}">
                                                                                        </label>
                                        ...
                                        <div class="" style='text-align:left'>
                                            <span style='font-size: 15px;'>Click <a href='terms' style='cursor:pointer'
                                                                                    id='terms-alert' target='_blank'>here</a> to read the terms of service.</span>
                                        ...
                                        <div class="form-notif">
                                            <div
                                                class="form-notif-wrap d-flex vertical-align flex-content-spacebetween
                    ...
                    @isset($totalPrice)
                        ...
                        <span class="tooltips agreement-tip" tooltip="" tooltip-position="left"
                              style='border:transparent; color:black;'>
                            <i class="fa fa-question-circle" aria-hidden="true"></i>
                        </span>
                                                            {!! Form::button('Place Order',
                                                             ['class' => 'btn ', 'type' => 'submit', 'id' => 'place-order-button']
                                                             ) !!}
                                                        </div>
                                                    @else
                                                ...
                                                @else
                                                    <div>
                                                        @if(!session('id') && session('cart') && !session('changePlanStatus') == 'Upgrade' && isset(session('cart')['business_verification']) && session('cart')['business_verification'] != null)
                                                            <a href='{{ route('clear.order') }}' class='btn'
                                                               id='clear-order'
