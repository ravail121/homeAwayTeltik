...
{{--			@include('processes.process-steps')--}}
			...
			<div class="row no-margin pad-top-10 text-center padding-left-right-10 pt-0">
                ...
                <h4 class="t-gray-2 add-bottom-1">
                    Click <a class="t-violet-2 download-invoice system-text" href="{{ $url }}">here</a>
                    to download your invoice for order number <span class="t-violet-2 system-text">
                        {{ isset($cart['order_num']) ? $cart['order_num'] : '' }}</span></h4>
						...
						@endforeach
							...
							<div class="confirm-calculation pull-right">
								...
								<div class="confirm-calculation-holder2">
									...
									<a href="{{ url('/#devices-section') }}" class="btn style2 system-background">Go Back To Shop</a>
								</div>
