<ul class="cpNav">
    <li><a class='monthly-billing-linka' href="{{ route('plans.details') }}">Monthly Billing</a></li>
    <li><a class='billing-history-linka' href="{{ route('history') }}">Billing History</a></li>
    <li><a class='account-page-link' href="{{ route('account') }}">
            <span>Welcome</span>
...
<aside class="bill">
    <div class="billWrapper">
        ...
        <a href="{{ route('account') }}#payment">Edit Billing Preferencesa</a>

        <a href="#" class="button make-payment-button" data-toggle="modal" data-target="#paymentModal">Make Payment</a>
    </div>
                ...
                <form id="make-payment-form">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 col-md-4">
                            ...
                            <input type="text" id="amount" name="amount" class="form-control effect-1"
                                   aria-describedby="emailHelp" placeholder="Please Enter Amount"
                                   value="{{ $invoices['total'][0] + $invoices['total'][1]/100 }}">
                            <span class="focus-border"></span>
                        </div>
                    </div>
                    <div class="row">
