                ...
                <section class="billPlans cp-section" id='billPlans-section'>
                                        ...
                                        @else
                                            <li class="firstli">
                                                ...
                                                <div class="text-center show-usages-btn">
                                                    <button type="button" class="btn style2 show-usages system-background"
                                                            data-toggle="modal" data-target="#usageModal"
                                                            data-phone="{{ $subcription['phone_number'] }}"
                                                            data-subscription="{{ $subcription['id'] }}">
                                                        View Usage
                                                    </button>
                                                </div>
                                            </li>
                  ...
                  <a href="#" class="addLine">Add a new line <i>+</i></a> Add 4 or more lines and receive a discount of $5/line per month! <strong>Use Code <em>MULTI45</em></strong>
                        ...
                        <div class="totals">
                            ...
                            <div class="grandTotal system-color">
                                <span>Monthly Total</span>
                                $@convert($subcriptions['monthlyAmountDetails']['monthlyTotalAmount'])
                            </div>
                        </div>
                    @else
