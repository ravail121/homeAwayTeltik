        						...
        						<div class="add-top-5">
        							{!! Form::open(['route' => 'devices.store', 'id' => 'form-plans']) !!}
                                        ...
                                        <a href="#" class="btn style2
                                         sm-half-left xs-full-width
                                          add-to-cart add-to-cart-btn"
                                            {{--  data-toggle="modal" data-target="#modalProceed" --}}>
                                            Add aato cart without plan
                                        </a>
                                    ...
                                    {!! Form::button(
                                            'Add to cart and choose plan',
                                             [
                                                 'type' => 'submit',
                                                  'class' => 'btn style2 add-left-2 sm-half-left sm-add-top-15 xs-full-width d-none',
                                                   'name' => 'with_plan',
                                                    'value' => 'with_plan',
                                                     'id' => 'choose-plan'
                                                     ]) !!}
