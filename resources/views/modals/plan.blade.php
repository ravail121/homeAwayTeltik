                        ...
                        {!! Form::hidden('plan_area_code', null, ['class' => "plan_area_code"]) !!}
                            {!! Form::open(['route' => 'plans.store', 'id' => 'form-with-plan']) !!}
                                ...
                                <section class="sim-section">
                                    <div class="bold t-black-1 f16 text-left add-bottom-15">+ Select Your Sim here <span class="text-danger"> *</span></div>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-8 d-none">
                                            <div class="form-group">
                                                {!! Form::text('sim_number', '',
                                                 ['class' => 'form-control', 'id' => 'sim-number', 'aria-describedby' => 'sim-number', 'style' => 'max-width: 290px', 'placeholder' => 'Enter sim number']) !!}
                                            </div>
                                        </div>
									</div>
								</section>
                                ...
                                <section class="port-section">
                                    ...
                                    <div class="port-number d-none">
                                        <div class="form-group">
                                            {!! Form::text('port_number', '999-999-9999',
                                             ['class' => 'form-control porting-number', 'id' => 'port-number', 'aria-describedby' => 'port-number', 'style' => 'max-width: 290px', 'placeholder' => '000-000-0000']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class='form-check add-bottom-15 d-inline add-right-3'>
                                            ...
                                            <p class="add-bottom-2 t-gray-2 f12">
                                                Dial <span class="t-violet-2 system-text">*#06#</span> from your device to locate your IMEI number.
                                            </p>
