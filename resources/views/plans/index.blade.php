...
@section('content')
    ...
    <!-- content -->
    <section class="choose-device-content mb-0 mt-0">
        <div class="container">
...
{{--            @include('processes.process-steps')--}}
            ...
            <div class="row no-margin text-center">
                ...
                <div class="add-top-6 xs-add-top-4 xs-add-top-100">
                    <!-- Nav tabs -->
                ...
                if (sessionCart.length != 0) {
                    ...
                    for (var k = 0; k < orderGroups.length; k++) {
                        if(orderGroups[k].id === activeGroupId) {
                            ...
                            if (activeGroupId == 0) {
                                window.location.href = "/#devices-section";
...
<style>
    #chooseDeviceTab li.active, .btn.style2 {
        background: var(--system-background-with-gradient) !important;
    }

    .tab-content .plan-wrap .item .price-wrap, .tab-content .device-wrap .item .price-wrap, .btn.style3 {
    ...
    .tab-content .plan-wrap .item .item-wrap .triangle, .tab-content .device-wrap .item .item-wrap .triangle {
        border-top: 50px solid var(--system-color) !important;
    }
</style>
