        ...
        >
            ...
            <div class="col-xl-6 col-xxl-5 text-center text-xl-start mt-0">
                <div class="left-side">
                    ...
                    <h2 class="heading my-4">
                        Feel safe at home and away with the Libris 2.0 4G LTE
                    </h2>
                    <div class="button-box mt-5">
                        <a
                            href="javascript:void(0)" id="firstOrderLibre"
            ...
            <div class="col-xl-6 align-self-center d-none d-xl-block">
                <div class="right-side">
                    <div class="hero-img">
                        <img
                            src="{{ asset('theme/onePlus/page-2/hero-img.png') }}"
                            alt="image"
                            class="img-fluid"
                        />
                    </div>
                                ...
                                <nav>
                                    ...
                                    >
                                        ...
                                        <img
                                            ...
                                            aria-selected="false"
                                            src="{{ asset('theme/onePlus/page-2/product-angle-2.webp') }}"
                                            alt="image"
                                        />
                                        <!-- Product Angel 3 -->
                                        <img
                                            ...
                                            aria-selected="false"
                                            src="{{ asset('theme/onePlus/page-2/product-angle-3.jpg') }}"
                                            alt="image"
                                        />
                                        <!-- Product Angel 4 -->
                                        <img
                                            ...
                                            aria-selected="false"
                                            src="{{ asset('theme/onePlus/page-2/product-angle-4.png') }}"
                                            alt="image"
                                        />
                                    </div>
                                </nav>
                ...
                <div class="right-side">
                    ...
                    <div class="product-card card border-0 p-3">
                        ...
                        >
                            <!-- About -->
                            <div class="about">
                                <h2 class="heading" id="device_name">Libris 2.0</h2>
                                    ...
                                    <div class="media d-flex">
                                        <img
                                            src="{{ asset('theme/onePlus/page-3/Icon_right.png') }}"
                                             alt="icon" class="img-fluidn" style="margin-top: 5px;">
                                        <div class="media-body ms-2">
                                            <p class="para-text mb-0">Fall detection included</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="media d-flex">
                                        <img src="{{ asset('theme/onePlus/page-3/Icon_right.png') }}" alt="icon" class="img-fluidn" style="margin-top: 5px;">
                                        <div class="media-body ms-2">
                        ...
                        {!! Form::open(['route' => 'plans.store', 'id' => 'libris-plan-form']) !!}
                        {!! Form::hidden('plan_id', 130) !!}
                        {!! Form::hidden('device_id', 87) !!}

                        <div class="button-box mt-3">
                            <a
                                href="javascript:void(0)" id="orderLibre"
                                class="button button-gradient button-big-rounded d-block w-100 text-center choose-device"
                            >Order Now</a
                            >
                        </div>
{{--                        <span class="mb-0 text-start d-block w-100 choose-device" id="orderLibre">Call to order onve</span>--}}
                        {!! Form::close() !!}
    ...
    <div class="container">
        ...
        <div class="features mt-5">
            <div class="row g-4 g-xl-0 justify-content-center position-relative">
                ...
                >
                    <img
                        src="{{ asset('theme/onePlus/page-2/features-middle-image.png') }}"
                        alt="imafe"
                        class="w-100"
                    />
                </div>
                ...
                >
                    <div class="col-xl-3 m-auto">
                        <img
                            src="{{ asset('theme/onePlus/page-2/features-icon-1.svg') }}"
                            alt="icon"
                ...
                <div class="col-md-6 col-xl-3 text-xl-end mt-xl-5 pt-xl-5">
                    <img
                        src="{{ asset('theme/onePlus/page-2/features-icon-2.svg') }}"
                        alt="icon"
                        class="img-fluid features-icon d-xl-none"
                    />
                    <h3 class="card-heading">Waterproof</h3>
                    <p class="para-text mt-3">
                        Your Libris is IP67 waterproof, allowing you to have
                ...
                <div class="col-md-6 col-xl-3 mt-xl-5 pt-xl-5">
                    <img
                        src="{{ asset('theme/onePlus/page-2/features-icon-3.svg') }}"
                        alt="icon"
                        class="img-fluid features-icon d-xl-none"
                    />
                    <h3 class="card-heading">So many ways to wear it</h3>
                    <p class="para-text mt-3">
                        Your Libris is so easy to wear to suit just about any lifestyle.
                ...
                <div class="col-md-6 col-xl-3 text-xl-end mt-xl-5 pt-xl-5">
                    <img
                        src="{{ asset('theme/onePlus/page-2/features-icon-4.svg') }}"
                        alt="icon"
                        class="img-fluid features-icon d-xl-none"
                    />
                    <h3 class="card-heading">Fall Detection Included</h3>
                    <p class="para-text mt-3">
                        Automatically initiates a call to our agents if the device
                        detects a fall. If you can not respond, help is immediately dispatched.
                    </p>
                </div>
                ...
                <div class="col-md-6 col-xl-3 mt-xl-5 pt-xl-5">
                    <img
                        src="{{ asset('theme/onePlus/page-2/features-icon-5.svg') }}"
                        alt="icon"
                        class="img-fluid features-icon d-xl-none"
                    />
                    <h3 class="card-heading">Peace of Mind for Friends and Family</h3>
                    <p class="para-text mt-3">
                       Keep friends and family updated on your safety
                ...
                <div class="col-md-6 col-xl-12 text-xl-center mt-xxl-5">
                    <div class="col-xl-3 m-auto">
                        <img
                            src="{{ asset('theme/onePlus/page-2/features-icon-6.svg') }}"
                            alt="icon"
                            class="img-fluid features-icon d-xl-none"
                        />
...
@include('layouts.partials._one-plus-libris-how-it-works')
...
@push('js')
    <script>
        ...
        $(function(){
            ...
            document.getElementById('firstOrderLibre').addEventListener('click', insertDevice.bind(null, {
                device_id: 87,
                plan_id: 130,
            }));
            document.getElementById('orderLibre').addEventListener('click', insertDevice.bind(null, {
                device_id: 87,
                plan_id: 130,
            }));
