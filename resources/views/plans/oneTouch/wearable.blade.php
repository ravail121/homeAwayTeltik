    ...
    <div class="container">
        <div class="row g-5 align-items-center justify-content-center justify-content-lg-between">
            ...
            <div class="col-xl-6 col-xxl-5 text-center text-xl-start mt-0">
                <div class="left-side">
                    <h3 class="after-heading">DOT Wearable</h3>
                    <h2 class="heading my-4">
                        Turn your Smartphone into a Smart emergency response device</h2>
                    <div class="button-box mt-5">
                        <a href="javascript:void(0)" id="firstOrderWearable"
                           class="button button-gradient button-big-rounded d-block w-75 text-center">Order Now</a>
                    </div>
                    <!-- Free Shipping & Call to Order -->
                    <div class="free-shipping-and-call-to-order-box mt-5">
                        <div class="d-sm-flex align-items-center justify-content-center justify-content-xl-start">
                            <!-- Free Shipping -->
                            <a href="javascript:void(0)"
                               class="free-shipping d-flex align-items-center me-sm-4 justify-content-start">
                                ...
                                <p class="mb-0 ms-3" style="margin-top: 0px;">Free Shipping</p>
                            </a>
                            <!-- Call to Order -->
                            <a href="javascript:void(0)"
                               class="call-to-order d-flex align-items-center justify-content-start mt-4 mt-sm-0">
                                <img
                                    ...
                                    alt="shipping" class="img-fluid" />
                                <div class="ms-3">
                                    <span class="mb-0 text-start d-block w-100" >Call to order</span>
            ...
            <div class="col-xl-6 align-self-center d-none d-xl-block">
                <div class="right-side">
                    <div class="hero-img">
                        <img
                            src="{{ asset('theme/onePlus/page-4/hero-img.png') }}"
                    ...
                    <div class="product-img-tab">
                        <div class="row">
                            ...
                            <div class="col-md-3 d-none d-md-block">
                                <nav>
                                    <div class="nav flex-md-column nav-tabs border-0" id="nav-tab" role="tablist">
                                        <!-- Product Angel 1 -->
                                        <img class="nav-link active img-fluid" id="product-angel-1-tab"
                                             data-bs-toggle="tab" data-bs-target="#product-angel-1" role="tab"
                                             aria-controls="product-angel-1" aria-selected="true"
                                             src="{{ asset('theme/onePlus/page-4/product-angel-1.png') }}"
                                             alt="image" />
                                        <img
                                            ...
                                            aria-selected="false"
                                            src="{{ asset('theme/onePlus/page-4/product-angle-2.png') }}"
                                            alt="image"
                                        />
                                    </div>
                            ...
                            <div class="col-md-9">
                                <div class="tab-content" id="nav-tabContent">
                                    <!-- Product Angel 1 -->
                                    <div class="tab-pane fade show active text-center" id="product-angel-1"
                                         role="tabpanel" aria-labelledby="product-angel-1-tab">
                                        <img
                                            src="{{ asset('theme/onePlus/page-4/product-angel-1.png') }}"
                                             class="img-fluid" />
                                    </div>
                                ...
                                <nav>
                                    <div class="nav flex-md-column nav-tabs border-0" id="nav-tab" role="tablist">
                                        ...
                                        <img class="nav-link active img-fluid" id="product-angel-1-tab"
                                             ...
                                             alt="image" />
                                        <!-- Product Angel 2 -->
                                        <img class="nav-link img-fluid" id="product-angel-2-tab"
                                             data-bs-toggle="tab" data-bs-target="#product-angel-2" role="tab"
                                             aria-controls="product-angel-2" aria-selected="false"
                                             src="{{ asset('theme/onePlus/page-4/product-angle-2.png') }}"
                                             alt="image" />
                ...
                <div class="right-side">
                    ...
                    <div class="product-card card border-0 p-3">
                        ...
                        <div
                            ...
                            <!-- About -->
                            <div class="about">
                                <h2 class="heading" id="device_name">DOT Wearable</h2>
                                <p class="para-text mt-4" id="device_description">
                                    The Ultimate Medical alert safety Pendant
                                </p>
                            </div>
                            <!-- Price -->
                            <div class="price">
                        ...
                        <!-- Monthly Plan -->
                        <div class="monthly-plan d-flex justify-content-between align-items-center mt-4">
                            <div>
                                <p class="para-text mb-0">24  X 7 Monitoring</p>
{{--                                <p class="para-text mb-0">Unlimited Talk, Text, 2GB Data + Medical Alert</p>--}}
                            </div>
                            <div>
                                <h2 class="price mb-0">
                        ...
                        <div class="button-box mt-3">
                            <a href="javascript:void(0)" id="secondOrderWearable"
                               class="button button-gradient button-big-rounded d-block w-100 text-center">Order
                                Now</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="features mt-5">
            <div class="row g-4 g-xl-0 justify-content-center position-relative">
                ...
                <div class="col-lg-6 col-xxl-6 position-absolute features-middle-image d-none d-xl-block">
                    <img
                        src="{{ asset('theme/onePlus/page-4/features-middle-image.png') }}"
                        alt="imafe" class="w-100"
                         style="margin-top: 70px;" />
                </div>
                <!-- Features Top Item -->
                <div class="col-md-6 col-xl-12 text-xl-center features-top-item mb-xxl-5">
                    <div class="col-xl-3 m-auto">
                        <img
                            src="{{ asset('theme/onePlus/page-4/features-icon-1.svg') }}" alt="icon"
                             class="img-fluid features-icon d-xl-none" />
                        <h3 class="card-heading">Easy Set-up</h3>
                        <p class="para-text mt-3">
                            Assisted set-up process makes connecting your Home & Away wearable to your smartphone
                            simple.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-3 text-xl-end mt-xl-5 pt-xl-5">
                    <img
                        src="{{ asset('theme/onePlus/page-4/features-icon-2.svg') }}" alt="icon"
                         class="img-fluid features-icon d-xl-none" />
                    <h3 class="card-heading">Water resistant</h3>
                    <p class="para-text mt-3">
                        Can be worn in the rain or in shower
                    </p>
                </div>
                <!-- Features Middle Image Space 1 -->
                ...
                <div class="col-md-6 col-xl-3 mt-xl-5 pt-xl-5">
                    <img
                        src="{{ asset('theme/onePlus/page-4/features-icon-3.svg') }}" alt="icon"
                         class="img-fluid features-icon d-xl-none" />
                    <h3 class="card-heading">Peace of mind for friends
                        of family</h3>
                    <p class="para-text mt-3">
                        Home & Away helps keep friends and family updated on your safety with location updates, battery
                        and more - with your permission, all within our app.</p>
                </div>
                <!-- Features Left Item 2 -->
                <div class="col-md-6 col-xl-3 text-xl-end mt-xl-5 pt-xl-5">
                    <img
                        src="{{ asset('theme/onePlus/page-4/features-icon-4.svg') }}" alt="icon"
                         class="img-fluid features-icon d-xl-none" />
                    <h3 class="card-heading">So many ways to wear it</h3>
                    <p class="para-text mt-3">
                        Sleek and stylish. Wear on lanyard, wrist or key-chain.
                    </p>
                </div>
                ...
                <div class="col-md-6 col-xl-3 mt-xl-5 pt-xl-5">
                    <img
                        src="{{ asset('theme/onePlus/page-4/features-icon-5.svg') }}" alt="icon"
                         class="img-fluid features-icon d-xl-none" />
                    <h3 class="card-heading">Audio + Video & Location
                        Services</h3>
                    <p class="para-text mt-3">
                        Leverage the full features of your smartphone for intelligent response.
                    </p>
                </div>
                ...
                <div class="col-md-6 col-xl-12 text-xl-center mt-xxl-5">
                    <div class="col-xl-3 m-auto">
                        <img
                            src="{{ asset('theme/onePlus/page-4/features-icon-6.svg') }}" alt="icon"
                             class="img-fluid features-icon d-xl-none" />
                        <h3 class="card-heading">Get help anywhere 24x7</h3>
                        <p class="para-text mt-3">Up to 18 month battery life.</p>
                    </div>
                </div>
            </div>
        </div>
...
@push('js')
    <script>
        const currentPlanId = 131;
        const currentDeviceId = 89;
        ...
        $(function(){
            ...
            document.getElementById('firstOrderWearable')
                .addEventListener('click', insertDevice.bind(null, {
                    device_id: 89,
                    plan_id: 131,
                    buy_sim: 'yes',
                }));

            document.getElementById('secondOrderWearable')
                .addEventListener('click', insertDevice.bind(null, {
                    device_id: 89,
                    plan_id: 131,
                    buy_sim: 'yes',
