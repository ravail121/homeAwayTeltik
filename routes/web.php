...
Route::get('get-all-plans', 'PlanController@getAllPlans')->name('get-all-plans');
Route::get('one-touch-plans', 'PlanController@oneTouchPlans')->name('one-touch-plans');
Route::get('libris-2', 'PlanController@libris2')->name('libris2');
Route::get('wearable', 'PlanController@wearable')->name('wearable');
Route::get('studio-mini', 'PlanController@studioMini')->name('studio-mini');

Route::post('sample-image', 'SampleImageController@fileUpload')->name('test.image');

Route::post('save-libris-transaction', 'PlanController@saveLibris')->name('plan.save_libris');
...
Route::get('clear-session', 'OrderHashController@clearSession');

// Checkout routes
Route::get('checkout', 'CheckoutController@index')->name('checkout.index');
Route::get('one-checkout', 'CheckoutController@oneTouchIndex')->name('checkout.one-touch-index');
...
// Static Contents
Route::middleware('isNewCustomer')->group(function() {
    Route::get('/', 'StaticPageController@one')->middleware('isNewCustomer');
    Route::get('/one', 'StaticPageController@one')->middleware('isNewCustomer');
    Route::get('/two', 'StaticPageController@two')->middleware('isNewCustomer');
    ...
    Route::get('/one-touch-support', 'SupportController@oneTouchSupportIndex')->name('support.oneTouchSupportIndex');
    Route::get('/one-touch-support-2', 'SupportController@oneTouchSupportIndexSecond')
        ->name('support.oneTouchSupportIndexSecond');
});
